...
class ConsultaSerializer(serializers.ModelSerializer):
    class Meta:
        model = Consulta
        fields = ['id', 'paciente', 'medico', 'fecha', 'hora', 'estado', 'motivo_consulta', 'genero', 'tipo_sangre', 'alergias', 'edad', 'tipo_consulta', 'embarazo', 'archivo_pdf', 'enfermedad_base', 'medicacion', 'cirugias']
