...
const Conocenos = () => {
  ...
  const dataToSend = {
    ...
    especialidad:
      formData.especialidad === "Otros"
        ? formData.especialidadPersonalizada
  ...
  try {
    ...
    if (data.success) {
      ...
      setSubmitted(true);
      setTimeout(() => setSubmitted(false), 3000); // Oculta el texto tras 3 segundos
    } else {
          ...
          <div className="para-medicos-content">
            <div className="para-medicos-text animate-on-scroll">
              ...
              <p className="contacto-medicos">
                ...
                <a href="mailto:servesa07@gmail.com">servesa07@gmail.com</a>, contactanos al{" "}
                <a href="tel:+59168449128">+591 68449128</a> o llena el siguiente formulario.
              </p>
            </div>
            <div className="para-medicos-form animate-on-scroll">
              ...
              <button type="submit" className="submit-btn" disabled={loading}>
                {loading ? (
                  <div className="spinner-solicitud-med"></div>
                ) : submitted ? (
                  "Solicitud enviada"
                ) : (
                  "Enviar Solicitud"
